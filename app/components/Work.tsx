    ...
    <div id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <div className='grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] my-10 gap-5'>
        {workData.map(({title,description,bgImage},index)=>(
          <div key={index} className='aspect-square bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group' style={{backgroundImage: `url("../assets/public/work-1.png")`}}>
          ...
          <a href="" className='w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] rounded-full py-3 px-10 mx-auto hover:bg-[#fcf4ff] duration-500'>Show more <Image src={assets.right_arrow_bold} alt='arrow' className='w-4' /></a>
    </div> 
  )
}
